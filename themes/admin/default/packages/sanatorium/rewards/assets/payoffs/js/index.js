...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'payoff');

		$('.daterangepicker_end_input').attr('data-grid', 'payoff');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('payoff', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
