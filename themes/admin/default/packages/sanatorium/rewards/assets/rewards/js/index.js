...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'reward');

		$('.daterangepicker_end_input').attr('data-grid', 'reward');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('reward', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
